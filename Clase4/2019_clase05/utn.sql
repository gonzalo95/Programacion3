...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-04-2019 a las 22:30:02
...
CREATE TABLE `productos` (
  `pNumero` int(11) NOT NULL,
  `pNombre` varchar(30) COLLATE utf8mb4_spanish2_ci DEFAULT NULL,
  `Precio` float DEFAULT NULL,
  `Tamanio` varchar(20) COLLATE utf8mb4_spanish2_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish2_ci;
...
--
ALTER TABLE `provedores`
  MODIFY `Numero` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=109;
COMMIT;
